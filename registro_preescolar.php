...
<head>
    ...
    <title>Registrar Alumno de Preescolar</title>
...
<body>
        ...
        <div class="row">
            <div class="col s12">
                <div class="form-container">
                    <div class="header">
                        <h2 class="text-center">REGISTRAR ALUMNO DE PREESCOLAR</h2>
                    </div>
                    <form id="registroForm" method="post" action="guardar_preescolar.php" enctype="multipart/form-data">
    ...
    <div id="successModal" class="modal">
        ...
        <div class="modal-footer">
            <a href="registro_preescolar.php" class="modal-close waves-effect waves-green btn-flat">Nuevo Registro</a>
