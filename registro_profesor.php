...
<body>
        ...
        <div class="row">
            <div class="col s12">
                <div class="form-container">
                    <div class="header">
                        <h2 class="text-center">CREAR NUEVO USUARIO DE PROFESOR</h2>
                    </div>
                    <form id="registroForm" method="post" action="guardar_profesor.php" enctype="multipart/form-data">
                        ...
                        <div class="file-field input-field">
                            <div class="file-path-wrapper">
                                <input class="file-path validate" type="text" placeholder="Añadir PDF de CURP">
                                <div class="btn">
                        ...
                        <div class="file-field input-field">
                            <div class="file-path-wrapper">
                                <input class="file-path validate" type="text" placeholder="Añadir acta de nacimiento">
                                <div class="btn">
                                    <span><i class="material-icons">attach_file</i></span>
                                    <input type="file" id="acta_nacimiento" name="acta_nacimiento" accept="application/pdf">
                                </div>
                            </div>
                        </div>
                        <div class="file-field input-field">
    ...
    <div id="successModal" class="modal">
        ...
        <div class="modal-footer">
            <a href="registro_profesor.php" class="modal-close waves-effect waves-green btn-flat">Nuevo Registro</a>
